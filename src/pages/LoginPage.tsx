...
const LoginPage: React.FC = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // Asynchronously 'signs in using an email and password'. => That return a 'Promise <firebase.auth.UserCredential>'
    ...
    return (
        <IonPage>
            ...
            {/* ONLY AND ONLY IF the 'error==true' => show '<IonText.../>' */}
            {status.error && <IonText color="danger">Invalid credentials</IonText>}  {/* ==== {error ? <IonText ... /> : null} */}    
            <IonButton expand="block" onClick={handleLogin} /* onClick={onLogin} */ >Login</IonButton>
